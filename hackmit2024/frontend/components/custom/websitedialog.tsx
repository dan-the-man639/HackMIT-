...
import ICategoryNodeProps from "../models/Node";
import CategoryNode from "@/app/_shared/components/CategoryNode";

interface IWebsiteDialogProps {
  data: ICategoryNodeProps;
  isOpen: boolean;
  setIsOpen: Dispatch<SetStateAction<boolean>>;
}

export default function WebsiteDialog(props: IWebsiteDialogProps) {
  let { imageSource, nodeLabel, dialogTitle, dialogContents, externalSources } =
    props.data;
